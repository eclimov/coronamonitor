...
sched.add_job(channel.telegram_send_advice, 'cron', hour='5-20/3', minute='1')
sched.add_job(channel.telegram_send_image, 'cron', hour='6-21/4', minute='32')
sched.add_job(channel.telegram_send_poll, 'cron', hour='5-20/7', minute='25')
