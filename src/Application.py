...
sched.add_job(channel.telegram_send_statistics_by_countries, 'cron', hour='20', minute='10')
sched.add_job(channel.telegram_send_statistics_summary, 'cron', hour='22', minute='35')
sched.add_job(channel.telegram_send_image, 'cron', day='*/2', hour='5', minute='32')
